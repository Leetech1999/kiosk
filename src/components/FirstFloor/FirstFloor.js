...
function FirstFloor() {
    ...
    const departments = [
        { id: 'a_1', name: '응급의학과', x: 180, y: 30 },
        { id: 'a_2', name: '소아청소년과', x: 1005, y: 500 },
        { id: 'a_3', name: '호흡기내과', x: 1185, y: 270 },
        { id: 'a_4', name: '이비인후과', x: 785, y: 30 },
        { id: 'a_5', name: '내분비내과', x: 400, y: 460 },
        { id: 'a_6', name: '직업환경의학과', x: 570, y: 250 },
        { id: 'a_7', name: '혈액종양내과', x: 805, y: 500 },
        { id: 'a_8', name: '핵의학과', x: 600, y: 490 },
        { id: 'a_9', name: '혈관외과', x: 800, y: 265 },
        { id: 'a_10', name: '재활의학과', x: 180, y: 460 },
        { id: 'a_11', name: '정형외과', x: 540, y: 30 }
    ];
                ...
                <div className="svg_container">
                    <svg width="1300" height="630" viewBox="0 0 1500 740" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g transform="translate(-150, 0)">
                            ...
                            <image href="/images/b_1.png" x="200" y="40" width="200" height="180" />
                            ...
                            <image href="/images/b_2.png" x="1065" y="505" width="220" height="180" />

                            <rect x="1185" y="270" width="160" height="210" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_3.png" x="1155" y="290" width="220" height="180" />
                            ...
                            <image href="/images/b_4.png" x="785" y="40" width="200" height="180" />
                            ...
                            <image href="/images/info.png" x="1145" y="25" width="160" height="130" />

                            <rect x="400" y="460" width="180" height="230" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_5.png" x="380" y="490" width="220" height="180" />
                            ...
                            <image href="/images/b_6.png" x="550" y="255" width="210" height="170" />

                            <rect x="805" y="500" width="180" height="190" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_7.png" x="785" y="505" width="220" height="180" />

                            <rect x="600" y="490" width="190" height="200" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_8.png" x="580" y="500" width="220" height="180" />

                            <rect x="800" y="265" width="160" height="190" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_9.png" x="770" y="270" width="220" height="180" />
                            ...
                            <image href="/images/b_10.png" x="170" y="490" width="220" height="180" />

                            <rect x="540" y="30" width="240" height="200" stroke="#333" strokeWidth="1" fill="none" />
                            <image href="/images/b_11.png" x="550" y="40" width="220" height="180" />
